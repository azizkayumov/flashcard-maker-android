...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
     ...
     */
    /**
     * SetDb the lower text size limit and invalidate the view
     * @param minTextSize
     */
     ...
     */
    /**
     * SetDb flag to add ellipsis to text that overflows at the smallest text size
     * @param addEllipsis
     */
     ...
     */
    /**
     * SetDb the upper text size limit and invalidate the view
     * @param maxTextSize
     */
    ...
    // SetDb the text size of the text paint object and use a static layout to render text off screen before measuring
